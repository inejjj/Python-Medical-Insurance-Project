...
print("The change in cost of insurance after increasing the age by 4 year is " + str(change_in_insurance_cost) + " dollars.")
...
print("The change in estimated cost for not having children is " + str(change_in_insurance_cost) + "dollars.")
